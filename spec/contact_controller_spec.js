...
describe("ContactController", () => {
  ...
  describe("#getContact()", () => {
    it("should return an empty array if no contacts are available", (done) => {
    ...
    it("should return an array of contacts when they are available", (done) => {
      this.book.addContact("Alice", "100-101-1010", "alice@example.com")
      .then(() => {
        this.book.getContacts()
        .then((contacts) => {
  ...
  describe("search methods", () => {
    ...
    const magus = ["Magus Johnson", "101-010-1011", "magus@squaresoft.com"];
    const alloy = ["Alloy Rodriguez", "111-111-1111", "allow@guerilla-games.com"];
        ...
        .then(() => {
          ...
          .then(() => {
            ...
            .then((contacts) => {
              ...
              expect(contact.phone).toBe("101-010-1011");
    ...
    it("should return the contact when found", (done) => {
      ...
      .then(() => {
        ...
        .then((contact) => {
          ...
          expect(contact.phone).toBe("100-100-1000");
